REM Shell script to install the Simulation PKG for the 3DCityDB
...
REM Run INSTALL_Simulation_PKG.sql to install the Simulation PKG into the 3DCityDB instance
