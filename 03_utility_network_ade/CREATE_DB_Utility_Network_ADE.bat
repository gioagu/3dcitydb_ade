REM Shell script to install the Utility Network ADE for the 3DCityDB
...
REM Run INSTALL_Utility_Network_ADE.sql to install the Utility Network ADE extension into the 3DCityDB instance
