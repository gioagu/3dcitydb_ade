...
interfeature_link_type:=NEW.interfeature_link_type,
...
id                       :=NEW.id                       ,
type                     :=NEW.type                     ,
cur_supply_flow_rate     :=NEW.cur_supply_flow_rate     ,
cur_supply_flow_rate_unit:=NEW.cur_supply_flow_rate_unit,
cur_supply_status        :=NEW.cur_supply_status        ,
pot_supply_flow_rate     :=NEW.pot_supply_flow_rate     ,
pot_supply_flow_rate_unit:=NEW.pot_supply_flow_rate_unit,
pot_supply_status        :=NEW.pot_supply_status        ,
...
id                       =%L,
type                     =%L,
cur_supply_flow_rate     =%L,
cur_supply_flow_rate_unit=%L,
cur_supply_status        =%L,
pot_supply_flow_rate     =%L,
pot_supply_flow_rate_unit=%L,
pot_supply_status        =%L,
cityobject_id            =%L
WHERE t.id=%L RETURNING id',
p_schema_name,
NEW.id                       ,
NEW.type                     ,
NEW.cur_supply_flow_rate     ,
NEW.cur_supply_flow_rate_unit,
NEW.cur_supply_status        ,
NEW.pot_supply_flow_rate     ,
NEW.pot_supply_flow_rate_unit,
NEW.pot_supply_status        ,
NEW.cityobject_id            ,
OLD.id
) INTO updated_id;
-- RAISE NOTICE 'Updated record with id: %', updated_id;
...
--ext_heigth        :=NEW.ext_heigth        ,
--ext_heigth_unit   :=NEW.ext_heigth_unit   ,
...
--int_heigth        :=NEW.int_heigth        ,
--int_heigth_unit   :=NEW.int_heigth_unit   ,
