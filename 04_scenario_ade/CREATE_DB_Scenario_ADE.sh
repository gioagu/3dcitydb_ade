#!/bin/sh
# Shell script to install the Scenario ADE for the 3DCityDB
...
# Run INSTALL_Scenario_ADE.sql to install the Scenario ADE extension into the 3DCityDB instance
