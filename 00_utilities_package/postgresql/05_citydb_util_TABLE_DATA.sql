...
--
-- This script add entries to the look-up tables (prefix lu_)
--
-- ***********************************************************************
-- ***********************************************************************
...
;
UPDATE citydb.lu_bridge_class SET name=lower(description);

TRUNCATE    citydb.lu_bridge_function_usage CASCADE;
INSERT INTO citydb.lu_bridge_function_usage
(id, description)
VALUES 
(1000, 'Railway bridge'),
(1010, 'Roadway bridge'),
...
(1060, 'Foot bridge'   )
;
UPDATE citydb.lu_bridge_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_building_class CASCADE;
INSERT INTO citydb.lu_building_class
(id, description) 
VALUES 
(1000, 'Habitation'),
(1010, 'Sanitation'),
...
(9999, 'Unknown')
;
UPDATE citydb.lu_building_class SET name=lower(description);

TRUNCATE    citydb.lu_building_function_usage CASCADE;
INSERT INTO citydb.lu_building_function_usage 
(id, description) 
VALUES 
...
;
UPDATE citydb.lu_building_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_building_roof_type CASCADE;
INSERT INTO citydb.lu_building_roof_type 
(id, description) 
VALUES 
(1000, 'Flat roof'),
(1010, 'Monopitch roof'),
...
;
UPDATE citydb.lu_building_roof_type SET name=lower(description);

TRUNCATE    citydb.lu_tunnel_class CASCADE;
INSERT INTO citydb.lu_tunnel_class
(id, description)
VALUES
(1000, 'Traffic'),
(1010, 'Supply'),
...
(1030, 'Others')
;
UPDATE citydb.lu_tunnel_class SET name=lower(description);

TRUNCATE    citydb.lu_tunnel_function_usage CASCADE;
INSERT INTO citydb.lu_tunnel_function_usage
(id, description)
VALUES
(1000, 'Railway tunnel'),
(1010, 'Roadway tunnel'),
...
;
UPDATE citydb.lu_tunnel_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_aux_traffic_area_function CASCADE;
INSERT INTO citydb.lu_aux_traffic_area_function
(id, description)
VALUES
(1000, 'Soft shoulder'),
(1010, 'Hard shoulder'),
...
(1700, 'Others')
;
UPDATE citydb.lu_aux_traffic_area_function SET name=lower(description);

TRUNCATE    citydb.lu_aux_traffic_area_surf_material CASCADE;
INSERT INTO citydb.lu_aux_traffic_area_surf_material
(id, description)
VALUES
(   1, 'Asphalt'),
(   2, 'Concrete'),
...
(9999, 'Unknown')
;
UPDATE citydb.lu_aux_traffic_area_surf_material SET name=lower(description);

TRUNCATE    citydb.lu_building_furniture_class CASCADE;
INSERT INTO citydb.lu_building_furniture_class
(id, description)
VALUES
(1000, 'Habitation'),
(1010, 'Sanitation'),
...
(1180, 'Function')
;
UPDATE citydb.lu_building_furniture_class SET name=lower(description);

TRUNCATE    citydb.lu_building_furniture_function_usage CASCADE;
INSERT INTO citydb.lu_building_furniture_function_usage
(id, description)
VALUES
(1000, 'Cupboard'),
(1010, 'Wardrobe'),
...
(2860, 'Mirror')
;
UPDATE citydb.lu_building_furniture_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_building_installation_class CASCADE;
INSERT INTO citydb.lu_building_installation_class
(id, description)
VALUES
...
(1060, 'Others')
;
UPDATE citydb.lu_building_installation_class SET name=lower(description);

TRUNCATE    citydb.lu_building_installation_function_usage CASCADE;
INSERT INTO citydb.lu_building_installation_function_usage
(id, description)
VALUES
(1000, 'Balcony'),
(1010, 'Winter garden'),
...
(1070, 'Others')
;
UPDATE citydb.lu_building_installation_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_city_furniture_class CASCADE;
INSERT INTO citydb.lu_city_furniture_class
(id, description)
VALUES
(1000, 'Traffic'),
(1010, 'Communication'),
...
(1030, 'Others')
;
UPDATE citydb.lu_city_furniture_class SET name=lower(description);

TRUNCATE    citydb.lu_city_furniture_function_usage CASCADE;
INSERT INTO citydb.lu_city_furniture_function_usage
(id, description)
VALUES
...
(1540, 'Others')
;
UPDATE citydb.lu_city_furniture_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_cityobjectgroup_class CASCADE;
INSERT INTO citydb.lu_cityobjectgroup_class
(id, description)
VALUES
(1000, 'Building separation'),
(2000, 'Assembly')
;
UPDATE citydb.lu_cityobjectgroup_class SET name=lower(description);

TRUNCATE    citydb.lu_cityobjectgroup_function_usage CASCADE;
INSERT INTO citydb.lu_cityobjectgroup_function_usage
(id, description)
VALUES
(1000, 'Lod1storey'),
(1010, 'Lod2storey'),
...
(1030, 'Lod4storey')
;
UPDATE citydb.lu_cityobjectgroup_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_int_building_installation_class CASCADE;
INSERT INTO citydb.lu_int_building_installation_class
(id, description)
VALUES
...
(9999, 'Unknown')
;
UPDATE citydb.lu_int_building_installation_class SET name=lower(description);

TRUNCATE    citydb.lu_int_building_installation_function_usage CASCADE;
INSERT INTO citydb.lu_int_building_installation_function_usage
(id, description)
VALUES
(1010, 'Radiator'),
(1020, 'Oven'),
...
(8020, 'Stair')
;
UPDATE citydb.lu_int_building_installation_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_landuse_class CASCADE;
INSERT INTO citydb.lu_landuse_class
(id, description)
VALUES
...
(4000, 'Water')
;
UPDATE citydb.lu_landuse_class SET name=lower(description);

TRUNCATE    citydb.lu_landuse_function_usage CASCADE;
INSERT INTO citydb.lu_landuse_function_usage
(id, description)
VALUES
(1010, 'Residential'),
...
(4040, 'Sea')
;
UPDATE citydb.lu_landuse_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_plant_cover_class CASCADE;
INSERT INTO citydb.lu_plant_cover_class
(id, description)
VALUES
(1010, 'Lemnetea'),
...
(9999, 'Unknown')
;
UPDATE citydb.lu_plant_cover_class SET name=lower(description);

TRUNCATE    citydb.lu_plant_cover_function_usage CASCADE;
INSERT INTO citydb.lu_plant_cover_function_usage
(id, description)
VALUES
(1010, 'Lemnetea'),
(1020, 'Asplenietea Rupestris'),
...
(9999, 'Unknown')
;
UPDATE citydb.lu_plant_cover_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_room_class CASCADE;
INSERT INTO citydb.lu_room_class
(id, description)
VALUES
(1000, 'Habitation'),
(1010, 'Administration'),
...
(1150, 'Function')
;
UPDATE citydb.lu_room_class SET name=lower(description);

TRUNCATE    citydb.lu_room_function_usage CASCADE;
INSERT INTO citydb.lu_room_function_usage
(id, description)
VALUES
(1000, 'Living room'),
(1010, 'Bedroom'),
...
(3420, 'Function room')
;
UPDATE citydb.lu_room_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_sol_vegetationobject_class_function_usage CASCADE;
INSERT INTO citydb.lu_sol_vegetationobject_class_function_usage
(id, description)
VALUES
(1000, 'Shrub'),
(1010, 'Low plants'),
...
(9999, 'Unknown')
;
UPDATE citydb.lu_sol_vegetationobject_class_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_sol_vegetationobject_species CASCADE;
INSERT INTO citydb.lu_sol_vegetationobject_species
(id, description)
VALUES
(1000, 'Picea'),
(1010, 'Pinus'),
...
(9999, 'Unknown')
;
UPDATE citydb.lu_sol_vegetationobject_species SET name=lower(description);

TRUNCATE    citydb.lu_traffic_area_function CASCADE;
INSERT INTO citydb.lu_traffic_area_function
(id, description)
VALUES
(   1, 'Driving lane'),
(   2, 'Footpath'),
...
(9999, 'Unknown')
;
UPDATE citydb.lu_traffic_area_function SET name=lower(description);

TRUNCATE    citydb.lu_traffic_area_usage CASCADE;
INSERT INTO citydb.lu_traffic_area_usage
(id, description)
VALUES
(   1, 'Pedestrian'),
(   2, 'Car'),
...
(9999, 'Unknown')
;
UPDATE citydb.lu_traffic_area_usage SET name=lower(description);

TRUNCATE    citydb.lu_traffic_area_surf_material CASCADE;
INSERT INTO citydb.lu_traffic_area_surf_material
(id, description)
VALUES
(    1, 'Asphalt'),
(    2, 'Concrete'),
...
(99990, 'Unknown')
;
UPDATE citydb.lu_traffic_area_surf_material SET name=lower(description);

TRUNCATE    citydb.lu_transportation_complex_class CASCADE;
INSERT INTO citydb.lu_transportation_complex_class
(id, description)
VALUES
(1000, 'Private'),
(1010, 'Common'),
...
(1090, 'Others')
;
UPDATE citydb.lu_transportation_complex_class SET name=lower(description);

TRUNCATE    citydb.lu_transportation_complex_function_usage CASCADE;
INSERT INTO citydb.lu_transportation_complex_function_usage
(id, description)
VALUES
(1000, 'Road'),
...
(2700, 'Others')
;
UPDATE citydb.lu_transportation_complex_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_waterbody_class CASCADE;
INSERT INTO citydb.lu_waterbody_class
(id, description)
VALUES
(1000, 'Sea'),
...
(9999, 'Unknown')
;
UPDATE citydb.lu_waterbody_class SET name=lower(description);

TRUNCATE    citydb.lu_waterbody_function_usage CASCADE;
INSERT INTO citydb.lu_waterbody_function_usage
(id, description)
VALUES
...
(9999, 'Unknown')
;
UPDATE citydb.lu_waterbody_function_usage SET name=lower(description);

TRUNCATE    citydb.lu_water_surf_water_level CASCADE;
INSERT INTO citydb.lu_water_surf_water_level
(id, description)
VALUES
...
(9999, 'Unknown')
;
UPDATE citydb.lu_water_surf_water_level SET name=lower(description);
...
Utilities Package table data installation complete!
...
END
$$;
SELECT 'Utilities Package table data installed correctly!'::varchar AS installation_result;
