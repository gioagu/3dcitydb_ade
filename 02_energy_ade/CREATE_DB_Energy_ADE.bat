REM Shell script to install the Energy ADE for the 3DCityDB
...
REM Run INSTALL_Energy_ADE.sql to install the Energy ADE extension into the 3DCityDB instance
